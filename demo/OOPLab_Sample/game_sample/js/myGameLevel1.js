		...
		/*this.position = {
			...
			y: 100
			    ...
			    click: function (e) {
			        ...
			        console.log(e.x, e.y);
			        if (!(this.downArrow.position||this.downArrow.position.x + 597||this.downArrow.position.y||this.downArrow.position.y + 800)) {
			            return;
			        }

			        else if(e.x >= this.downArrow.position.x && e.x <= this.downArrow.position.x + 597 && e.y >= this.downArrow.position.y && e.y <= this.downArrow.position.y + 800) {
								this.audio.stopAll();
